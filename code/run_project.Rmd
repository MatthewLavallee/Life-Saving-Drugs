...
source(here("code","create_data","fpl","create_fpl.R"), local = knitr::knit_global())
# purpose: script pulls poverty numbers and creates df
# source: https://aspe.hhs.gov/sites/default/files/documents/8e7483715719918e8fddb58ab23f606d/Guidelines-1983-2022.xlsx
# output: here("trunk","raw","FPL","fpls.xlsx")
...
# purpose: reads in ahrf data for table 1
# output: here("trunk","raw","AHRF","ahrf.txt")
```
...
#purpose: creates all variants of potential figure 1, not currently in manuscript

source(here("code","create_analysis","create figs","fig2.R"), local = knitr::knit_global())
# purpose creates variants of figure 2, currently in manuscript as quintile transition figure

source(here("code","create_analysis","create figs","fig3.R"), local = knitr::knit_global())
# purpose creates variants of figure 3, currently in manuscript as map transition
```
